...
`,e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"textures"})," :"]})," This is the pointer this function will fill in with an id for the generated texture. Multiple buffers can be filled in using a pointer to the first element of an array of sufficient size or some pointer followed by sufficient allocated space."]}),`
`]})]}),`
...
`,e.exports.jsx(r,{images:[{src:"/labs/lab11/FinalKitten.png",alt:"TODO"}],figNumber:4,targetWidth:"80%",figCaption:"FBO Attachments"}),`
...
`]}),e.exports.jsxs("details",{children:[" ",e.exports.jsx("summary",{children:e.exports.jsxs(t.p,{children:["What is the ",e.exports.jsx(t.code,{children:"m_devicePixelRatio"})," variable ",e.exports.jsx(t.code,{children:"m_screen_width"}),", ",e.exports.jsx(t.code,{children:"m_screen_height"}),", ",e.exports.jsx(t.code,{children:"m_fbo_height"}),", and ",e.exports.jsx(t.code,{children:"m_fbo_width"})," are all initialized with?"]})}),e.exports.jsxs(t.p,{children:[`For high density displays such as retina displays on many Mac computers, there is a discrepancy
...
`,e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"height"})," :"]})," This is the height of the desired renderbuffer. For our purposes, use ",e.exports.jsx(t.code,{children:"m_fbo_height"}),"."]}),`
`]}),e.exports.jsxs(t.blockquote,{children:[`
...
`,e.exports.jsx(t.p,{children:'Submit your Github repo for this lab to the "Lab 11: Textures & FBOs" assignment on Gradescope, then get checked off by a TA during lab hours.'}),`
`,e.exports.jsx(i,{}),e.exports.jsx(t.style,{children:`
...
`})]})]})}function x(s={}){const{wrapper:t}=s.components||{};return t?e.exports.jsx(t,Object.assign({},s,{children:e.exports.jsx(n,s)})):n(s)}export{x as default,h as documentProps};
